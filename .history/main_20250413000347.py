...
async def main():
    ...
    for username in target_users:
        await message_handler.handle_conversation(username, "making money online")
    
    # Option 2: Target users from hashtags
    target_hashtags = ["sidehustle", "makemoney", "entrepreneurship"]
    for hashtag in target_hashtags:
        users = await get_users_from_hashtag(client, hashtag)
